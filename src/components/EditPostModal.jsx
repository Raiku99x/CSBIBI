...
export default function EditPostModal({ post, profile, subjects, onClose, onUpdated }) {
  ...
  const formIsMaterial = form.sub_type === 'material'
  ...
  return (
    ...
    >
      <div style={{
        ...
        <div style={{
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          padding: '14px 16px', borderBottom: '1px solid #E4E6EB', position: 'relative',
        }}>
          <span style={{ fontFamily: '"Bricolage Grotesque", system-ui', fontWeight: 800, fontSize: 17, color: '#050505' }}>
            Edit Post
          </span>
          <button onClick={onClose} style={{
            position: 'absolute', right: 12, width: 36, height: 36, borderRadius: '50%',
        ...
        <form onSubmit={handleSave}>
          <div style={{ padding: '12px 16px' }}>
            ...
            <div style={{
              ...
              background: '#F7F8FA', borderRadius: 8, border: '1px solid #E4E6EB', marginBottom: 14,
            }}>
              {(formIsAnnouncement
                ? [
                ...
                >
                  <span style={{ fontWeight: 700, fontSize: 13, color: form.sub_type === key ? '#050505' : '#65676B' }}>
                    {label}
                  </span>
                </button>
              ))}
